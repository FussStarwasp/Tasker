namespace Tasker.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        NumberOfDaysToComplete = c.Int(nullable: false),
                        ChoreStatus_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ChoreStatus", t => t.ChoreStatus_Id)
                .Index(t => t.ChoreStatus_Id);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Chores", new[] { "ChoreStatus_Id" });
            DropIndex("dbo.ChoreItems", new[] { "Items_Id" });
            DropIndex("dbo.ChoreItems", new[] { "ChoreId" });
